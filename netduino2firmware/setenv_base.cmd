...
@echo     where COMPILER_TOOL_VERSION is ADI5.0, GCC4.2, GCC4.5, GCC4.6, ADS1.2, RVDS3.0, RVDS3.1, RVDS4.0,  RVDS4.1, MDK3.1, MDK3.80a, MDK4.12, MDK4.13, SHC9.2, VS9, VS10
@echo.
GOTO :EOF
...
IF /I "%COMPILER_TOOL_VERSION%"=="GCC4.5"   CALL :SET_GCC_VARS 
IF /I "%COMPILER_TOOL_VERSION%"=="GCC4.6"   CALL :SET_GCC_VARS 
...
IF /I "%COMPILER_TOOL_VERSION%"=="GCCOP4.5" CALL :SET_GCC_VARS
...
) ELSE IF "%COMPILER_TOOL_VERSION%"=="GCC4.5" (

set GNU_VERSION=4.5.2
set ARMINC=%ARG3%\lib\gcc\arm-none-eabi\%GNU_VERSION%\include
set ARMLIB=%ARG3%\lib\gcc\arm-none-eabi\%GNU_VERSION%
set GNU_TOOLS=%ARG3%
set GNU_TOOLS_BIN=%ARG3%\bin
...
) ELSE IF "%COMPILER_TOOL_VERSION%"=="GCC4.6" (

set GNU_VERSION=4.6.0
set ARMINC=%ARG3%\lib\gcc\arm-none-eabi\%GNU_VERSION%\include
set ARMLIB=%ARG3%\lib\gcc\arm-none-eabi\%GNU_VERSION%
set GNU_TOOLS=%ARG3%
set GNU_TOOLS_BIN=%ARG3%\bin
