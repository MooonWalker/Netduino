...
USBD_Status  USBD_StdDevReq (USB_OTG_CORE_HANDLE  *pdev, USB_SETUP_REQ  *req)
{
  ...
  //printf("USBD_StdDevReq:bRequest=%i, wValue=%i, wIndex=%i, wLength=%i\r\n",
  //  (int)req->bRequest, (int)req->wValue, (int)req->wIndex, (int)req->wLength);
...
USBD_Status  USBD_StdItfReq (USB_OTG_CORE_HANDLE  *pdev, USB_SETUP_REQ  *req)
{
  ...
  //printf("USBD_StdItfReq status=%i\r\n", (int)pdev->dev.device_status);
...
USBD_Status  USBD_StdEPReq (USB_OTG_CORE_HANDLE  *pdev, USB_SETUP_REQ  *req)
{
  ...
  //printf("USBD_StdEPReq:bRequest=0x%02X, wValue=0x%04X, wIndex=0x%04X, wLength=0x%04X\r\n",
  //  (int)req->bRequest, (int)req->wValue, (int)req->wIndex, (int)req->wLength);
