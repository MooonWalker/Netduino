...
#elif defined(PLATFORM_ARM_Netduino2) || defined(PLATFORM_ARM_NetduinoPlus2) || defined(PLATFORM_ARM_NetduinoShieldBase)
#define SPI1_SCLK_Pin (0x05)  // PA5
...
BOOL CPU_SPI_Initialize()
{
    ...
    CPU_GPIO_EnableInputPin(SPI1_SCLK_Pin, FALSE, NULL, GPIO_INT_NONE, RESISTOR_PULLDOWN);
	CPU_GPIO_EnableInputPin(SPI1_MOSI_Pin, FALSE, NULL, GPIO_INT_NONE, RESISTOR_PULLDOWN);
    CPU_GPIO_EnableInputPin(SPI1_MISO_Pin, FALSE, NULL, GPIO_INT_NONE, RESISTOR_PULLDOWN);

    CPU_GPIO_EnableInputPin(SPI2_SCLK_Pin, FALSE, NULL, GPIO_INT_NONE, RESISTOR_PULLDOWN);
	CPU_GPIO_EnableInputPin(SPI2_MOSI_Pin, FALSE, NULL, GPIO_INT_NONE, RESISTOR_PULLDOWN);
    CPU_GPIO_EnableInputPin(SPI2_MISO_Pin, FALSE, NULL, GPIO_INT_NONE, RESISTOR_PULLDOWN);

    CPU_GPIO_EnableInputPin(SPI3_SCLK_Pin, FALSE, NULL, GPIO_INT_NONE, RESISTOR_PULLDOWN);
	CPU_GPIO_EnableInputPin(SPI3_MOSI_Pin, FALSE, NULL, GPIO_INT_NONE, RESISTOR_PULLDOWN);
    CPU_GPIO_EnableInputPin(SPI3_MISO_Pin, FALSE, NULL, GPIO_INT_NONE, RESISTOR_PULLDOWN);
