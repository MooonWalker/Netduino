...
{
	{ BlockRange::BLOCKTYPE_CODE      ,   0,   0 },  // 08000000 BOOT        16k
    { BlockRange::BLOCKTYPE_RESERVED  ,   1,   2 },  // 08004000 empty       32k
    { BlockRange::BLOCKTYPE_CONFIG    ,   3,   3 },  // 08004000 config      16k
};
